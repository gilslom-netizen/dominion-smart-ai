...
fn main() {
    ...
    for &temp in &[1.0f32, 1.5, 2.5, 4.0] {
        for &c in &[2.5f32, 6.0, 12.0] {
            ...
            let cfg = MctsConfig { worlds: 16, iterations: 800, exploration: c, ..Default::default() };
